...
SecurityClientHandler.prototype.AddTimestamp = function(doc, security) {
  var timestamp = utils.appendElement(doc, security, consts.security_utility_ns, "u:Timestamp", null)
    ...
    , expires_timespan = 5
        ...
        var created = utils.appendElement(doc, timestamp, consts.security_utility_ns, "u:Created", created_time.toISOString())
          , expires = utils.appendElement(doc, timestamp, consts.security_utility_ns, "u:Expires", expires_time.toISOString())
}
